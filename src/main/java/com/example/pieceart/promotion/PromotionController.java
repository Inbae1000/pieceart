...
public class PromotionController {
    ...
    // 프로모션 등록
    @PostMapping
    public ResponseEntity<Map<String, Object>> createPromotion(@RequestBody PromotionDTO promotionDTO){
        ...
        System.out.println(created.getWorksId());
        log.info(created);
        log.info(created.getWorks());
